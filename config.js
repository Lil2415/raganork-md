...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~acfbe7725703b1c5b368f05de8b397a1:7769746274582b353273453d',
    ...
    SUDO: process.env.SUDO || "254756418391",
